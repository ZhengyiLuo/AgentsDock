...
import test_goal_followup_lifecycle_isolated as ordinary_fixture
...
nodes = [node for node in ast.parse(Path(__file__).with_name("agent_server.py").read_text()).body
