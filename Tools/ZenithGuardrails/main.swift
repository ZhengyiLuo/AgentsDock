...
func checkMacTimelineScrollPerformanceGuards() throws {
    ...
    try assert(appKitTimeline.contains("AppKitTimelineClampingClipView") && appKitTimeline.contains("override func setBoundsOrigin") && appKitTimeline.contains("native-overscroll-clamping"), "Native scrolling must synchronously clamp every clip-origin write without changing wheel deltas")
