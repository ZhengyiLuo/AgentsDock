...
func checkRuntimeDefaultLabels() throws {
    ...
    try assert(server.contains("normalized_effort = normalize_runtime_effort(BACKEND_CODEX, sess.get(\"effort\"))"), "Codex launch must defensively normalize persisted effort values")
