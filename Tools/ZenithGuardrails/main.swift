...
func checkMacTimelineScrollPerformanceGuards() throws {
    ...
    try assert(!appKitTimeline.contains("scrollView.verticalLineScroll = 48") && appKitTimeline.contains("scheduleFallbackWheel"), "AppKit timeline must preserve native wheel speed and use fallback only for swallowed events")
