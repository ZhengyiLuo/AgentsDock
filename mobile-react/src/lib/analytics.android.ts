...
import { buildTrackPayload, MIXPANEL_TRACK_URL } from './analytics-payload'
import type { AnalyticsEvent, AnalyticsEventProps } from './analytics-events'

// Lightweight, dependency-free Mixpanel client for Android. It sends explicit
// app-owned aggregate payloads without a persistent or generated analytics ID.
//
...
/** Fire-and-forget Android analytics. Network failures never affect the app. */
