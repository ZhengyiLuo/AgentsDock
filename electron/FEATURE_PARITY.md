...
- [x] Structured `@` and `/chat` cross-chat handoffs with durable target turns,
  auditable lifecycle cards, exact target/action authorization, and restart-safe queues
...
- [x] Per-chat cwd explorer, quick open, pinned Chat/file tabs, lazy syntax
  highlighting, draft recovery, and revision-checked text editing
