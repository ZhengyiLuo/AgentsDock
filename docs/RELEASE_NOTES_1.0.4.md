...
Candidate release notes. Exact stable-package acceptance and publication are
pending.
...
keeps a failed update visible. Interrupted activation retains independent native
recovery and verified rollback.
